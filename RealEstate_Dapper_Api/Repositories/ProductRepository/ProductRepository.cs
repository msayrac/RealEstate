...
namespace RealEstate_Dapper_Api.Repositories.ProductRepository
{
    public class ProductRepository : IProductRepository
    {
        ...
        {
            string query = "Select P.ProductID, P.Title,P.Price,P.City,P.District,C.CategoryName, P.CoverImage,P.Type,P.Address, P.DealOfTheDay, P.SlugUrl From Product P join Category C on C.CategoryID=P.ProductCategory";
        ...
        public async Task<List<ResultLast3ProductWithCategoryDto>> GetLast3ProductAsync()
        {
            ...
            string query = "Select Top(3) ProductID, Title, Price, City, District, ProductCategory, CategoryName, AdvertisementDate,CoverImage,Description From Product Inner Join Category on Category.CategoryID=Product.ProductCategory Order By ProductID Desc";
		...
		public async Task<List<ResultProductWithCategoryDto>> GetProductByDealOfTheDayTrueWithCategoryAsync()
		{
			...
			string query = "Select P.ProductID, P.Title,P.Price,P.City,P.District,C.CategoryName, P.CoverImage,P.Type,P.Address, P.DealOfTheDay From Product P join Category C on C.CategoryID=P.ProductCategory Where DealOfTheDay=1";
        ...
        {
            string query = "Select P.ProductID, P.Title,P.Price,P.City,P.District, P.Description,C.CategoryName, P.CoverImage,P.Type,P.Address, P.DealOfTheDay, P.AdvertisementDate, P.SlugUrl From Product P join Category C on C.CategoryID=P.ProductCategory Where P.ProductId=@productId";

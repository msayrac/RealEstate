...
namespace RealEstate_Dapper_UI.Controllers
{
    public class StatisticsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage9 = await client9.GetAsync("https://localhost:44373/api/Statistics/CityNameByMaxProductCount");
            ...
            var responseMessage10 = await client10.GetAsync("https://localhost:44373/api/Statistics/DifferentCityCount");
            ...
            var responseMessage11 = await client11.GetAsync("https://localhost:44373/api/Statistics/EmployeeNameByMaxProductCount");
            ...
            var responseMessage12 = await client12.GetAsync("https://localhost:44373/api/Statistics/LastProductPrice");
            ...
            var responseMessage13 = await client13.GetAsync("https://localhost:44373/api/Statistics/NewestBuildingYear");
            ...
            var responseMessage14 = await client14.GetAsync("https://localhost:44373/api/Statistics/OldestBuildingYear");
            ...
            var responseMessage15 = await client15.GetAsync("https://localhost:44373/api/Statistics/PassiveCategoryCount");
            ...
            var responseMessage16 = await client16.GetAsync("https://localhost:44373/api/Statistics/ProductCount");

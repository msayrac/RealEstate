...
namespace RealEstate_Dapper_UI.Controllers
{
	public class BottomGridController : Controller
	{
		...
		public async Task<IActionResult> CreateBottomGrid(CreateBottomGridDto createBottomGridDto)
		{
			...
			var responseMessage = await client.PostAsync("https://localhost:44373/api/BottomGrids", stringContent);
		...
		public async Task<IActionResult> UpdateBottomGrid(int id)
		{
			...
			var responseMessage = await client.GetAsync($"https://localhost:44373/api/BottomGrids/{id}");
			if (responseMessage.IsSuccessStatusCode)
			{
				var jsonData = await responseMessage.Content.ReadAsStringAsync();
		...
		public async Task<IActionResult> UpdateBottomGrid(UpdateBottomGridDto updateBottomGridDto)
		{
			...
			var responseMessage = await client.PutAsync("https://localhost:44373/api/BottomGrids/", stringContent);
		...
		public async Task<IActionResult> DeleteBottomGrid(int id)
		{
			...
			var responseMessage = await client.DeleteAsync($"https://localhost:44373/api/BottomGrids/{id}");
			if (responseMessage.IsSuccessStatusCode)
			{
				return RedirectToAction("Index");
			}
